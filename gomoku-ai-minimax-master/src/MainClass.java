...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		final int width = 760;
		final MainGUI gui = new MainGUI(1000,1000, "GoMoku");
		...
		gui.listenGameStartButton(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				int computerStarts = (int)(settings[1]);
				
				System.out.println("Depth: " + depth + " GameModel: " + computerStarts );
				...
				game.setGameModel(computerStarts);
